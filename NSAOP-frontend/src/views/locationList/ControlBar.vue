        ...
        <div class="right-panel">
          ...
          >
            <el-form-item prop="title" >
              <el-input v-model="queryForm.title" placeholder="名称/详细地址" />
            </el-form-item>
            <el-form-item>
              <el-button
                icon="el-icon-search"
...
import {SET_TOKEN, SET_LOCATION_TARGET} from "@/common/store";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        title: [
          {
            validator: lengthValidator(0, 10),
            trigger: "change",
          }
        ]
      },
  ...
  methods: {
    ...
    handleQuery() {
      this.$store.dispatch(SET_LOCATION_TARGET, {data: this.queryForm.title})
      this.$emit("reload")
    }
  },
  mounted() {
